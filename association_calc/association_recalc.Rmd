...
regionalplt <- read.csv('~/Desktop/usgfbi_50fishnet_mergeed_new_20240109.csv')
...
trees <- read.csv('~/Desktop/usgfbi_recentadult_trees_newplotid.csv')
...
table(trees$management)

summary(trees$management)
